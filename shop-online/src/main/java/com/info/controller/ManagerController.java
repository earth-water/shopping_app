...
import com.info.config.UserPrincipal;
...
//	For Category--------------------------------------------------
	...
	public ModelAndView listCategory(@ModelAttribute("category") Category category) {
	...
	public ModelAndView deleteCategory(@ModelAttribute("category") Category category,@PathVariable("categoryId")String categoryId) {
		ModelAndView mv = new ModelAndView("manager/category-form");
	...
	public ModelAndView updateCategory(@ModelAttribute("category") Category category,@PathVariable("categoryId")String categoryId) {
...
//	For Product--------------------------------------------------
	...
	public ModelAndView listProduct(@ModelAttribute("product") Product product) {
...
//	}
	...
	public ModelAndView deleteProduct(@ModelAttribute("product") Product product,@PathVariable("productId")String productId) {
		ModelAndView mv = new ModelAndView("manager/product-form");
	...
	public ModelAndView updateProduct( @ModelAttribute("product") Product product,  @PathVariable("productId")String productId) {
